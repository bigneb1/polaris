...
export default function DisputeDetail() {
  ...
  if (error) return <ErrorNotice message="Couldn't load this dispute. Check your connection and try again." />;
      ...
      <div className="grid gap-6 lg:grid-cols-[1.5fr_1fr]">
        <div className="flex min-w-0 flex-col gap-6">
          ...
          <Panel title="AI jury verdict">
            ...
            {dispute.genLayerDecisionId && (
              <div className="mono mt-3 break-all text-[10px] text-grey">GenLayer: {dispute.genLayerDecisionId}</div>
            )}
          </Panel>

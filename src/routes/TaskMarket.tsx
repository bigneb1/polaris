...
import { StatCard, USDCAmount, Panel, Skeleton, EmptyState, ErrorNotice } from "../components/ui/primitives";
  ...
  return (
    <div>
      <PageHeader
        ...
        sub="Open tasks, locked escrow, and the live settlement feed - indexed straight from Arc onchain events, no application database."
        action={
      ...
      <div className="grid gap-6 lg:grid-cols-[1.55fr_1fr]">
        ...
        <div className="min-w-0">
          ...
          <div className="flex flex-col gap-3">
            {!coreDeployed() ? (
              ...
              <ErrorNotice message="Couldn't load the task market. Check your connection and try again." />
            ) : isLoading ? (
        ...
        <div className="flex min-w-0 flex-col gap-6">
          ...
          <Panel title={<span className="inline-flex items-center gap-2"><Activity size={13} /> Live Activity</span>}>
            {activityError ? (
              <ErrorNotice message="Couldn't load the activity feed." />
            ) : activity.length === 0 ? (

  ...
  return (
    <div>
      <PageHeader
        ...
        title="The swarm"
        sub="Every registered agent, ranked by reputation - indexed live from Arc onchain events."
      />
      ...
      {!coreDeployed() ? (
        ...
        <ErrorNotice message="Couldn't load the agent registry. Check your connection and try again." />
      ) : isLoading ? (

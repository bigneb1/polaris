...
import { StatCard, Panel, EmptyState, ErrorNotice, Skeleton, USDCAmount, StatusBadge, ProgressBar } from "../components/ui/primitives";
  ...
  return (
    <div>
      ...
      {!coreDeployed() ? (
        ...
        <ErrorNotice message="Couldn't load the settlement center. Check your connection and try again." />
      ) : (

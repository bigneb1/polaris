        ...
        for (const t of openTasks) {
          ...
          try {
            ...
            if (won?.toLowerCase() === persona.address.toLowerCase()) {
              ...
              await fetch(`${API_URL}/api/deliverable`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ taskId: t.taskId, agentWallet: persona.address, deliverable, signature }) });
